...
v.fnVersionCheck;var b=this,c=a===k,d=this.length;c&&(a={});this.oApi=this.internal=v.internal;for(var e in l.ext.internal)e&&(this[e]=Nb(e));this.each(function(){var e={},g=1<d?Ya(e,a,!0):a,j=0,i,e=this.getAttribute("id"),n=!1,m=l.defaults,q=h(this);if("table"!=this.nodeName.toLowerCase())K(null,0,"Non-index node initialisation ("+this.nodeName+")",2);else{gb(m);hb(m.column);J(m,m,!0);J(m.column,m.column,!0);J(m,h.extend(g,q.data()),!0);var r=l.settings,j=0;for(i=r.length;j<i;j++){var o=r[j];if(o.nTable==
...
k&&a!==null?new s(Vb(a,this.context)):this});o("index()",function(a){var a=this.tables(a),b=a.context;return b.length?new s(b[0]):a});t("tables().nodes()","index().node()",function(){return this.iterator("table",function(a){return a.nTable},1)});t("tables().body()","index().body()",function(){return this.iterator("table",function(a){return a.nTBody},1)});t("tables().header()","index().header()",function(){return this.iterator("table",function(a){return a.nTHead},1)});t("tables().footer()","index().footer()",
function(){return this.iterator("table",function(a){return a.nTFoot},1)});t("tables().containers()","index().container()",function(){return this.iterator("table",function(a){return a.nTableWrapper},1)});o("draw()",function(a){return this.iterator("table",function(b){if(a==="page")P(b);else{typeof a==="string"&&(a=a==="full-hold"?false:true);T(b,a===false)}})});o("page()",function(a){return a===k?this.page.info().page:this.iterator("table",function(b){Va(b,a)})});o("page.info()",function(){if(this.context.length===
