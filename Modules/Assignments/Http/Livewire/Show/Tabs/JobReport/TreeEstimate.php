...
class TreeEstimate extends Component {
...
/*        'plywoods'     => 'required',
    ...
    public function syncWorkers2($id)
    {
        ...
        JobReportWorkers::where('assignment_id', $this->assignment->id)
            ->where('job_type_id', $this->jobType_id)
            ->delete();
    ...
    {
        return view('assignments::livewire.show.tabs.job-report.tree-estimate');
    }
