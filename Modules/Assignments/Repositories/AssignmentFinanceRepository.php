...
class AssignmentFinanceRepository extends Assignment {
    ...
    protected $with    =['scheduling','referral','commissions','carrier','status','status_collection','event','phones','user_updated','user_created','job_types','invoices', 'payments','tags', 'workers'];
...
//                    dd($total_invoice);
                ...
                case 6:
                    // revise_payment
                    $status = ($balance !=0 && $total_payment <> $total_invoice) ? 24 : $status;
//@dump($total_payment);
//@dump($total_invoice);
                    $status_collection = 6;
                    break;
