<div>
   <h4 class="card-title mb-4">Signatures
      @if($listSigns->isEmpty())
         <button type="button" class="btn btn-warning btn-sm me-2  float-end" wire:click="$emit('addBlankSign')"><i class="fas fa-plus"></i> Blank Signature</button>
      @endif
   </h4>
   <div class="card">
      <div class="card-body">
