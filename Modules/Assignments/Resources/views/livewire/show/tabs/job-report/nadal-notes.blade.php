<div>
    ...
    @endif
    <h4 class="card-title mb-4">{{ $titleNotes }}</h4>
    <div class="card">
        <div class="card-body">
            ...
            @if($show)
                <div>
                    <div class="d-flex">
                        ...
                        <button type="button" {{(empty($this->notetext)) ?'disabled' : '' }} class="btn btn-success waves-effect waves-light  float-end" wire:click.prevent="addNewNoteNadal"><i class="bx bx-save font-size-16 align-middle me-2"></i></button>
                    </div>
                    <br>
                </div>
            @endif
