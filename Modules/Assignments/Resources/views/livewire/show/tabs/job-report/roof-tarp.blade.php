<div>
    <div class="card-body" div wire:key="jobreport1">
    @if(!$show)
    <div class="row">
        <div class="col-lg-12">
...
{{--                    <div class="col-xl-6 col-sm-6">--}}
{{--                        <div wire:ignore>--}}
{{--                            <select data-pharaonic="select2" data-component-id="111111" wire:model="workersSelected">--}}
