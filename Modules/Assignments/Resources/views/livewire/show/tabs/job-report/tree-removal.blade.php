                    ...
                    <div class="col-lg-12">
                        ...
                        @if($tsList->isNotEmpty())
                            @foreach($tsList as $ts)
                                <h5 class="text-end"> #{{$ts->length}} ft Length x {{$ts->diameter}} in Diameter - {{$ts->canopy}}ft Canopy <a href="#" wire:click.prevent="deleteTreesize({{$ts->id}})" class="btn btn-danger btn-sm waves-effect waves-light" ><i class="bx bx-trash"></i></a></h5>
                            @endforeach
                        ...
                        <div class="col-lg-12">
                            ...
                            @if($serviceList->isNotEmpty())
                                @foreach($serviceList as $sl)
                                    <h5 class="text-end"> # Start {{$sl->start_date_view}} To  {{$sl->end_date_view}} With  {{$sl->workers}} workers <a href="#" wire:click.prevent="deleteServicetime({{$sl->id}})" class="btn btn-danger btn-sm waves-effect waves-light" ><i class="bx bx-trash"></i></a></h5>
                                @endforeach
                            @else
                                <div class="alert alert-danger" role="alert">
                        ...
                        <div class="col-md-3">
                            <div class="mt-4">
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="formRadios7">
                                        No
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio"  name="bobcat_use"  wire:model="bobcat_use"
                                           id="formRadios8" value="Y" >
                                    <label class="form-check-label" for="formRadios8">
                                        Yes
                                    </label>
                                </div>
                                @error('debris')
...
{{--                                    </div>--}}
        ...
        @else
            <div class="col-lg-12">
                <h5 class="card-title mt-4">Tree Size <button type="button" class="btn btn-info btn-sm float-end" wire:click="$emit('editReport', {{$jobType_id}})"><i class="fas fa-edit"></i> Edit</button></p></h5>
            </div>
            <div class="row mt-2">
                <div class="col-lg-12">
                    <hr>
