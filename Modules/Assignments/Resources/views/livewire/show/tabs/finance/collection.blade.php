...
{{--                            <li><button class="dropdown-item" wire:click="setPreStatus(9)" type="button">LIEN PLACED</button></li>--}}
{{--                            <li><button class="dropdown-item" wire:click="setPreStatus(19)" type="button">PENDING SOLUTION</button></li>--}}
{{--                            <li><button class="dropdown-item" wire:click="changeStatus(21)"  type="button">CALLED</button></li>--}}
{{--                            <li><button class="dropdown-item" wire:click="changeStatus(22)" type="button">PAYMENT AGREEMENT</button></li>--}}
{{--                            <li><button class="dropdown-item" wire:click="changeStatus(11)"  type="button">LEFT MESSAGE</button></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
                </h7>
