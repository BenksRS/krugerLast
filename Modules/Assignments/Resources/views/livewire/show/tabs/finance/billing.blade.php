            ...
            <form class="needs-validation  was-validated" novalidate action="" wire:submit.prevent="newInvoice(Object.fromEntries(new FormData($event.target)))">
               <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="row">
                        <div class="col-md-6">
                           <label class="form-label">Invoice Number#</label> <input type="number" class="form-control" name="invoice_id"
                     ...
                     <div class="row mt-2">
                        <div class="col-md-6">
                           <label class="form-label">Billed Amount</label> <input type="text" class="form-control" name="billed_amount"
                        ...
                        <div class="col-md-6">
                           <label class="form-label">Before Fees Amount</label> <input type="text" class="form-control" name="fee_amount"
                     ...
                     <div class="row mt-2">
                        <div class="col-md-6">
                           <label class="form-label">Discount Amount</label> <input type="text" class="form-control" name="discount_amount"
                        ...
                        <div class="col-md-6">
                           <label class="form-label">Discount Settlement Amount</label> <input type="text" class="form-control" name="settlement_amount"
                        ...
                        @if($job_types > 0)
                           <div class="col-md-6">
                              <label class="form-label">Tree Amount</label> <input type="text" class="form-control" name="tree_amount"
                                    ...
                                    <td>
                                       @if($invoice->status !== 'paid')
                                          <button type="button" class="btn btn-sm btn-primary"
                                                  wire:click="$emit('editInvoice', {{ $invoice->id }})"
                                                  title="Edit Invoice {{ $invoice->invoice_id }}">
                                             <i class="fa fa-edit"></i>
                                          </button>

                                          @if($loop->count > 1 && in_array($user->group_id, [1, 4]))
                                             <button type="button" class="btn btn-sm btn-danger"
                                                     wire:click="$emit('disableInvoice', {{ $invoice->id }})"
                                                     title="Disable Invoice {{ $invoice->invoice_id }}">
