<div>
    ...
    @if($checkJobreport==0)
        <div class="alert alert-danger" role="alert">
           No Job report Found, finish before add an invoice!!!
        </div>
    @endif

    <h4 class="card-title mb-4">Billed Invoices @if(!$showAdd && $checkJobreport > 0)<button type="button" class="btn btn-primary btn-sm float-end" wire:click="$emit('addInvoice')"><i class="fas fa-plus"></i> <i class="fas fa-file-invoice"></i></button>@endif</h4>
