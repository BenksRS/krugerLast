...
<div class="card-body">
    <h4 class="card-title mb-4"># TARP REPAIR</h4>


    <div class="row">
        <div class="card-body">
            <h5 style="color: red;">Please confirm that you can charge for this repair !</h5>
        </div>
    </div>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="mt-4">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="tarpsituation"
