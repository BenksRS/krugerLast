...
trait AssignmentScope {
    ...
    public function scopeOpen(Builder $query,
        $status = [1, 2, 3, 4, 8, 11, 12, 14, 15, 17, 18, 19, 20, 21, 22, 23, 28, 14, 29, 27, 33, 34, 35, 37,38,39,40,54,55,56,57,59,60,61,62])
    {
    ...
    public function scopeReadytobill(Builder $query, $status = [4,58,59])
    {
        return $query->whereIn('status_id', collect($status))->whereNotNull('id');
    }
