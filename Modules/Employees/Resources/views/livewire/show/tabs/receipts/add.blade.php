                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="mb-3">
                            ...
                            <select class=" form-control select2-multiple select_carrier" wire:model="category" name="carrier_id" data-placeholder="Select ...">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="amount" placeholder="$0.00" wire:model.lazy="amount" required>
                        ...
                        <button type="submit" class="btn btn-success btn-sm float-start m-1" {{ ($photo && $amount && $category)? '' : 'disabled' }}>
