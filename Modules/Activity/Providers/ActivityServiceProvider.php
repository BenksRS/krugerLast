...
use Modules\Activity\Http\Middleware\ActivityRouteAccess;
...
class ActivityServiceProvider extends ServiceProvider {
    ...
    private function registerActivity()
    {
        ...
        Event::listen(Logout::class, function($e) {
            ActivityLog::create([
        ...
        // empurra para TODO request do grupo "web"
        $router->pushMiddlewareToGroup('web', ActivityRouteAccess::class);
    }
