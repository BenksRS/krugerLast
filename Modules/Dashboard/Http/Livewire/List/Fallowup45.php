...
class Fallowup45 extends Component {
    ...
    public function render()
    {
        ...
        $today            = Carbon::now();
        $list             = AssignmentFinanceRepository::Collection($this->selectedStatus)->whereDate('follow_up', '<=', $today)->search($searchAssignment)
        ...
        $list                   = $list->where('finance.collection.days_from_billing', '>', 44);
