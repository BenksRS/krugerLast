...
class WaitingEstimate extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $list = AssignmentRepository::open([54])->search($searchAssignment)->get();
        ...
        return view('dashboard::livewire.list.waiting-estimate', [
            'list' =>$list
        ]);
