...
class EstimateToBeSent extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $list = AssignmentRepository::open([58])->search($searchAssignment)->get();
        ...
        return view('dashboard::livewire.list.estimate-to-be-sent', [
            'list' =>$list
        ]);
