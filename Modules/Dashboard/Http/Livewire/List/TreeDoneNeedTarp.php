...
use Modules\Assignments\Repositories\AssignmentRepository;
	...
	class TreeDoneNeedTarp extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $list = AssignmentRepository::open([40])->search($searchAssignment)->get();
        ...
        return view('dashboard::livewire.list.tree-done-need-tarp', [
            'list' =>$list
        ]);
