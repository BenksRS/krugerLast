<?php
	...
	class MissingAssignment extends Component {
		...
		public    $columns         = [
			'Name', 'Job Type', 'Schedule', 'Status', 'Referral', 'Address', 'Street', 'City', 'State', 'Phone', 'Created by',
		...
		public function render ()
		{
			...
			$list             = AssignmentRepository::query()->where(function ($query) {
				$query->open([44])->orWhere->searchTags([36]);
			})->search($searchAssignment)->get();
			
/*			$list             = AssignmentRepository::open([44])->orWhere->searchTags([36])
			...
			return view('dashboard::livewire.list.missing-assignment', [
				'list' => $list
			]);
		}
