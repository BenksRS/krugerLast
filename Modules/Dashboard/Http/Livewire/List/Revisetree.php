...
class Revisetree extends Component {
    ...
    public    $columns         = [
        ...
        'Created by', 'Created At', 'Update By', 'Update At'
    ];
    ...
    public function render()
    {
        ...
        $list             = AssignmentFinanceRepository::revisetree()->search($searchAssignment)
                                                       ->where('created_at', '>', '2023-01-01 00:00:07')->get();

        $list = $list->filter(fn ($item) => $item->finance->invoices->tree_amount <= 0);
