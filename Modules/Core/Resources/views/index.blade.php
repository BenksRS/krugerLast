                ...
                <div class="bg-primary bg-soft">
                    <div class="row">
                        ...
                        <div class="col-5 align-self-end">
                            <img src="{{ themes('images/profile-img.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ themes('images/users/avatar-1.jpg') }}" alt="" class="img-thumbnail rounded-circle">
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h3>$34,252</h3>
                            <p class="text-muted"><span class="text-success me-2"> 12% <i class="mdi mdi-arrow-up"></i> </span> From previous period
                            </p>

                            <div class="mt-4">
                                <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light btn-sm">View More
                                    <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <h5><a href="javascript: void(0);" class="text-dark">Facebook -
                        ...
                        <a href="javascript: void(0);" class="text-primary font-16">Learn more
