...
class Jobs extends Component
{
    ...
    public $columns = ['Name','Job Type','Schedule','Status','Referral','Address','City','State', 'Created At','invoice`s', 'Billied Date', 'Total Invoice Amount', 'Paid Date', 'Paid Amount', 'Balance Amount', 'Claim Number', 'Billed By'];
