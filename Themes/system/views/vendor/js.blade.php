...
<script src="{{ themes('libs/jquery-ui-dist/jquery-ui.min.js') }}"></script>
...
<script src="{{ themes('libs/dragula/dragula.min.js') }}"></script>
...
<script src="{{ themes('libs/spectrum-colorpicker2/spectrum.min.js') }}"></script>
...
{{--<script src="{{ themes('libs/tui-time-picker/tui-time-picker.min.js') }}"></script>--}}
{{--<script src="{{ themes('libs/tui-date-picker/tui-date-picker.min.js') }}"></script>--}}

<script src="{{ themes('libs/moment/min/moment.min.js') }}"></script>

<script src="{{ themes('libs/chance/chance.min.js') }}"></script>

{{--<script src="{{ themes('libs/tui-calendar/tui-calendar.min.js') }}"></script>--}}

{{--<script src="{{ themes('js/pages/form-advanced.init.js') }}"></script>--}}

<!-- Syncscroll init js -->
<script src="{{ themes('libs/scrollsync/scrollsync.js') }}"></script>
